...
export type FormInputType = HTMLTextAreaElement | HTMLSelectElement | HTMLInputElement;
...
export interface IChangeEvent<T = Element> extends React.ChangeEvent<T> {
...
interface IChildrenProps {
  ...
  handleChange: (event: IChangeEvent<FormInputType> | React.FocusEvent<HTMLInputElement>) => void;
  handleBlur: (event: IChangeEvent<FormInputType> | React.FocusEvent<HTMLInputElement>) => void;
...
const Form = (props: IFormProps): React.ReactElement<IFormProps> => {
  ...
  const handleChange = (event: IChangeEvent<FormInputType> | React.FocusEvent<HTMLInputElement>): void => {
    event.persist();
    const {
