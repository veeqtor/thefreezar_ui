...
import { IChangeEvent, FormInputType } from 'modules/components/Form';
...
export interface IInputProps {
  ...
  value: string | number;
  required?: boolean;
  handleChange: (event: IChangeEvent<HTMLInputElement> | React.FocusEvent<HTMLInputElement>) => void;
  handleBlur?: (event: IChangeEvent<HTMLInputElement> | React.FocusEvent<HTMLInputElement>) => void;
